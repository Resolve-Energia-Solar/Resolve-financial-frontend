...
const DEFAULT_ROUTER = '/api/energy-companies';
const CompanyService = {
  ...
  find: async (id, params) => {
    try {
      ...
      console.error(`Erro ao buscar concessionária com id ${id}:`, error);
      throw error;
    }
  },
  create: async (data) => {
  ...
  update: async (id, data) => {
    try {
      ...
      console.error(`Erro ao atualizar concessionária com id ${id}:`, error);
      throw error;
    }
  },
  ...
  delete: async (id) => {
    try {
      ...
      console.error(`Erro ao deletar concessionária com id ${id}:`, error);
      throw error;
    }
  },
