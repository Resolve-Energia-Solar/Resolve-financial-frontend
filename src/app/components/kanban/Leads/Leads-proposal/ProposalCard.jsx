...
export function ProductList() {
  return (
    ...
    >
      ...
      >
        {/* CARD HEADER!!!!!!!!!!!!! */}
        <Grid item sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 1, mb: 1  }}>
          <Grid item xs={1}>
            <img
          ...
          <Grid item xs={8} sx={{ fontWeight: 'bold', ml: 1, mr: 10}}>
        ...
        {/* TABLE HEADER */}
        <Grid container sx={{ fontWeight: 'bold', mb: 1, ml: 2, mt: 2 }}>
          <Grid item xs={8}>
