  ...
  useEffect(() => {
    ...
    const fetchLead = async () => {
      ...
      try {
        ...
        setLastInspetion(
          data.schedules
            .filter((i) => i.service.id === parseInt(SERVICE_INSPECTION_ID))
            .sort((a, b) => new Date(b.schedule_date) - new Date(a.schedule_date))[0],
        );
        console.log(data);
      } catch (err) {
        ...
        >
          ...
          <Box sx={{ p: 3.5, borderBottom: '1px solid', borderRadius: 0, borderColor: '#F4F5F7' }}>
            ...
            >
              ...
              <Typography
                sx={{ color: '#000000', fontSize: '24px', fontWeight: '400', color: '#303030' }}
              >
                Vistoria técnica{' '}
                <Box
                  component="span"
          ...
          <Grid container spacing={6} sx={{ p: 3.5 }}>
            <Grid item xs={12} md={4}>
              <Typography
                gutterBottom
                sx={{ fontSize: '14px', fontWeight: '400', color: '#7E8388' }}
              >
                CPF
              </Typography>
              <Typography
            ...
            <Grid item xs={12} md={8}>
              ...
              <Typography
                gutterBottom
                sx={{ fontSize: '14px', fontWeight: '400', color: '#303030' }}
              >
                -
              </Typography>
            </Grid>
        ...
        <Grid container direction="column" spacing={2}>
          ...
          {proposals.length > 1 && (
            <Grid item>
              <Typography
                gutterBottom
                sx={{ fontSize: '14px', fontWeight: '400', color: '#7E92A2' }}
              >
                Outras propostas
              </Typography>
            </Grid>
