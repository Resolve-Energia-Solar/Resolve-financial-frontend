...
import DetailProduct from '@/app/components/apps/product/Product-detail';
import ProductService from '@/services/productsService';
import SearchInput from '@/app/components/forms/theme-elements/SearchInput';

const ListProducts = ({onAddProduct = null, onClosedModal=null}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.log('responseDefault: ', responseDefault);
  ...
  return (
    <>
      <Alert severity="info" sx={{ mb: 2 }}>
        <Typography variant="subtitle1">Selecione um produto nos três pontinhos</Typography>
      </Alert>
