...
const SchedulingList = () => {
  ...
  const filteredScheduleList = scheduleList.filter(
    (item) =>
      ...
      (!filter.schedule_start_time ||
        item.schedule_start_time.includes(filter.schedule_start_time)) &&
      (!filter.service || item.service.name.includes(filter.service)) &&
      (!filter.project || item.project.includes(filter.project)) &&
      (!filter.schedule_agent ||
        item.schedule_agent.complete_name.includes(filter.schedule_agent)) &&
