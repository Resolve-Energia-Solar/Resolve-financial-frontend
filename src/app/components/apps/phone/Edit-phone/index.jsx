...
const EditPhonePage = ({ phoneId = null, onClosedModal = null, onRefresh = null }) => {
  const userPermissions = useSelector((state) => state.user.permissions);

  const { loading, error, phoneNumberData } = usePhoneNumbers(phoneId);
  ...
  const {
    ...
    loading: formLoading,
    success,
  } = usePhoneNumberForm(phoneNumberData, phoneId);
