      ...
      <Box sx={{ padding: '22px', border: '1px solid #E0E0E0', borderRadius: '8px' }} >
        <Box sx={{
          ...
          <Box sx={{ marginBottom: '25px', display: 'flex', justifyContent: 'flex-end' }}>
            ...
            <Button variant="text" sx={{ backgroundColor: 'secondary.main', color: 'primary.contrastText' }}
        ...
        {data.length > 0 ? 
        <TableContainer sx={{ border: 'none', borderRadius: '8px', boxShadow: '10' }}>
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell align="left">% Repasse</TableCell>
