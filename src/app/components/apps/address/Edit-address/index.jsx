...
const EditAddressPage = ({ selectedAddressId = null, onClosedModal = null, addressId = null, onRefresh = null }) => {
  const userPermissions = useSelector((state) => state.user.permissions);

  const { loading, error, addressData } = useAddress(addressId);
  ...
  const {
    ...
    success,
    dataReceived,
  } = useAddressForm(addressData, addressId);
