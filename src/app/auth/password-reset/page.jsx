...
export default function PasswordReset() {
  return (
    <PageContainer title="Redefinição de Senha" description="Página para redefineção de senha">
        ...
        >
          <Box p={4}>
            ...
            <Typography color="textSecondary" variant="subtitle2" fontWeight="400" mt={2}>
              Por favor, insira sua nova senha e confirme-a para concluir o processo de redefineção.
            </Typography>
            <AuthPasswordReset />
          </Box>
        </Grid>
