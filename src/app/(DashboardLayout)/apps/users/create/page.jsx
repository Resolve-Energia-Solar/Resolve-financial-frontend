        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={12} lg={4}>
            <FormSelect
              ...
              {...(formErrors.contract_type && { error: true, helperText: formErrors.contract_type })}
            />
          </Grid>
          <Grid item xs={12} sm={12} lg={4}>
            <FormDate
          ...
          <Grid item xs={12} sm={12} lg={4}>
            ...
            <AutoCompleteUser
              ...
              {...(formErrors.user_manager_id && { error: true, helperText: formErrors.user_manager_id })}
            />
          </Grid>
          <Grid item xs={12} sm={12} lg={4}>
