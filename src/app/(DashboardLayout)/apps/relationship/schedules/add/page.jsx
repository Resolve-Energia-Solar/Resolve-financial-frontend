...
const RelationshipScheduleFormPage = () => {
            ...
            <Grid item xs={12} sm={6}>
              <GenericAsyncAutocompleteInput
                ...
                extraParams={{
                  ...
                  category__name: 'Relacionamento com Cliente'
                }}
                mapResponse={(data) =>
                  data.results.map((s) => ({
                    label: s.name,
                    ...
                    <li {...props}>
                      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Typography variant="body2">
                          ...
                          {option.status ? (
                            <StatusChip status={option.status} size='small' />
                          ) : (
...
export default RelationshipScheduleFormPage;
