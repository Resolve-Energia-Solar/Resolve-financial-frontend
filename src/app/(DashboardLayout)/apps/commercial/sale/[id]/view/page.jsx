...
export default function FormCustom() {
  ...
  return (
    <PageContainer title="Visualização de venda" description="Visualização">
      <Breadcrumb title="Visualizar Venda" />

      <ParentCard title="Venda" onEdit={() => handleEditClick(id)}>
        ...
        {value === 0 && (
          <Grid container spacing={3}>
            <Grid item xs={12} sm={12} lg={4}>
              ...
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>{saleData.lead.name}</CustomFormLabel>
            </Grid>
            <Grid item xs={12} sm={12} lg={4}>
              <CustomFormLabel htmlFor="name">Cliente</CustomFormLabel>
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>{saleData.customer.complete_name}</CustomFormLabel>
            </Grid>
            <Grid item xs={12} sm={12} lg={4}>
              <CustomFormLabel htmlFor="branch">Franquia</CustomFormLabel>
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>{saleData.branch.name}</CustomFormLabel>
            </Grid>
            <Grid item xs={12} sm={12} lg={4}>
              <CustomFormLabel htmlFor="name">Vendedor</CustomFormLabel>
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>{saleData.seller.complete_name}</CustomFormLabel>
            </Grid>
            <Grid item xs={12} sm={12} lg={4}>
              <CustomFormLabel htmlFor="name">Supervisor de Vendas</CustomFormLabel>
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>{saleData.sales_supervisor.complete_name}</CustomFormLabel>
            </Grid>
            <Grid item xs={12} sm={12} lg={4}>
              <CustomFormLabel htmlFor="name">Gerente de Vendas</CustomFormLabel>
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>{saleData.sales_manager.complete_name}</CustomFormLabel>
            </Grid>
            <Grid item xs={12} sm={12} lg={4}>
              <CustomFormLabel htmlFor="branch">Campanha de Marketing</CustomFormLabel>
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>{saleData.marketing_campaign.name}</CustomFormLabel>
            </Grid>
            <Grid item xs={12} sm={12} lg={4}>
              <CustomFormLabel htmlFor="valor">Valor</CustomFormLabel>
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>{formattedValue} </CustomFormLabel>
            </Grid>
            <Grid item xs={12} sm={12} lg={4}>
            ...
            <Grid item xs={12} sm={12} lg={4}>
              ...
              <CustomFormLabel sx={{ fontStyle: 'italic', fontWeight: 'light', borderBottom: '1px dashed #ccc' }}>
