...
const DocumentTypeList = () => {
  ...
  useEffect(() => {
    const fetchDocumentTypes = async () => {
      ...
      try {
        ...
        const data = await documentTypeService.index(params); // Assumindo que a API aceita esses parâmetros
  ...
  const handleConfirmDelete = async () => {
    try {
      await documentTypeService.delete(documentTypeToDelete);
  ...
  return (
    <PageContainer title="Tipos de Documentos" description="Lista de Tipos de Documentos">
      ...
      <Dialog open={open} onClose={handleCloseModal}>
        ...
        <DialogContent>
          <DialogContentText>
            Tem certeza de que deseja excluir este tipo de documento? Esta ação não pode ser
            desfeita.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
