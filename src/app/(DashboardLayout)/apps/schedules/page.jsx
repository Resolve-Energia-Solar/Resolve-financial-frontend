  ...
  useEffect(() => {
    ...
    scheduleService
      .index({
        ...
        fields: "id,service_opinion,final_service_opinion,customer,branch,address,schedule_agent,project.sale,service,observation,schedule_date,schedule_start_time,status,created_at,schedule_agent.profile_picture,schedule_agent.complete_name,schedule_agent.phone_numbers",
