...
export default function boardOperation() {
  ...
  const handleCardClick = async item => {
    ...
    setDataProject({
      ...
      sale: {
        ...item?.project.sale,
        customer: { ...item?.project.sale.customer, ...userData },
      },
    })
  }
  ...
  useEffect(() => {
    if (!cardSelected?.id_integration) {
      ...
      setContentType(
        cardSelected?.content_type?.model
          ? cardSelected?.content_type.model
          : cardSelected?.content_type,
      )
      ...
      setContentType(
        cardSelected?.content_type?.name
          ? cardSelected?.content_type.name
          : cardSelected?.content_type,
      )
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          ...
          message: 'O comentário foi salvo com sucesso!',
          type: true,
        })
      ...
      setMessage({
        ...
        message: 'O comentário não foi salvo com sucesso!',
        type: true,
      })
      setOpenModalMessage(true)
    }
    ...
    if (value == 'done') {
      try {
        ...
        setMessage({
          ...
          message: 'O status não foi alterado com sucesso!',
          type: false,
        })
      }
    }
  ...
  const saveNewTask = async item => {
    ...
    try {
      ...
      setMessage({
        title: 'Erro ao Salvar',
        message: 'A tarefa não foi salva com sucesso!',
        type: false,
      })
    }
  }
